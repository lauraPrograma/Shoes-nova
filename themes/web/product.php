            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="inicio.html">Home</a></li>
            ...
            <div class="container d-flex align-items-center flex-column">
                <div class="banner-container">
                    <div class="banner">
                        ...
                        <h2>Promoções</h2>
                        <p>Não perca nossas promoções incriveis</p>
                        </div>
                    </div>
                    <div class="banner">
                    <div class="banner-content">
                        <h2>Pagamento</h2>
                        <p>Fazemos até 10x sem juros</p>
                ...
                <!-- Masthead Heading-->
                <h1 class="masthead-heading text-uppercase mb-0">Venha conhecer nossos produtos</h1>
                <!-- Icon Divider-->
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0">Aqui você encontra o melhor preço
                </p>
            </div>
        </header>
        <!-- Footer-->
